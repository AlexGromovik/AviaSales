...
public class Ticket implements Comparable<Ticket>{
    ...
    public int flyTime(){ // Расчет времени полета
        int flyTime;
        if(timeFrom >= timeTo) {
            flyTime = (24 - timeFrom) + timeTo;
        } else {
            flyTime = timeTo - timeFrom;
        }
        return flyTime;
    }
    ...
    @Override
    public int compareTo(Ticket o) { // Сравнение и выбор наименньшей цены перелёта
